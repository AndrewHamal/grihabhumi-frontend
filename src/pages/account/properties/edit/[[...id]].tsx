...
export default function PropertyEdit({ property, id: queryId, features, categories }: any) {
    ...
    useEffect(() => {
        if (property) {
            reset({
                ...
                facilities: property?.facilities?.map((res: any) => ({ id: res?.pivot?.facility_id, distance: res?.pivot?.distance })) || '',
                features: property?.features || '',
                price: property?.price || '',
                video: property?.metadata?.meta_value?.[0] || '',
            ...
            setImages(Object.values(property?.images))
        }
    }, [property])
                ...
                <div className="container p-8 mx-auto">
                    <div className="relative overflow-x-auto rounded grid grid-cols-3 gap-6">
                        <div className="col-span-2 overflow-hidden">
                            <div className="bg-white shadow-req rounded px-6 py-5">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <Controller
                                            ...
                                            control={control}
                                            render={({ field: { onChange, value } }) => (
                                                <Select fontSize={14} value={value} onChange={(e) => onChange(e.target.value)}>
                                    ...
                                    {watch('type') == 'rent' && <div>
                                        ...
                                        <Controller
                                            ...
                                            control={control}
                                            render={({ field: { onChange, value } }) => (
                                                <Select className="capitalize" fontSize={14} value={value} onChange={(e) => onChange(e.target.value)}>
                        ...
                        <div className="sticky top-0 self-baseline">

...
import { Button, ButtonGroup, Card, CardBody, CardFooter, Divider, Heading, IconButton, Image, Popover, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverFooter, PopoverHeader, PopoverTrigger, Select, Spinner, Stack, Table, Tbody, Td, Text, Thead, Tr, useDisclosure, useMediaQuery } from "@chakra-ui/react";
...
export function Toggle({ id, mutate, size = 'sm' }: any) {
    ...
    return (<>
        ...
        <div className="sm:ml-64 bg-[#f5f5f9] h-[100vh] dashboard">
            <div className="container p-8 mx-auto">
                <div className={`relative ${isMobile ? '' : 'border rounded'} overflow-x-auto`}>
                            ...
                            <div className="flex gap-4 flex-wrap">
                                <div className="relative flex-grow">
                                    ...
                                    <input
                                        ...
                                        className=" p-2 text-[14px] ps-10 text-sm text-gray-900 border rounded bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Search"
                                    />
                                </div>
                                ...
                                <Link className="ml-auto flex-grow" href={'/account/properties/create'}>
                        ...
                        isMobile ? <>
                            <div>
                                {data?.data?.map((res: any, key: number) => (
                                    <>
                                        <Card marginBottom={5} key={key} maxW='sm'>
                                            <CardBody>
                                                {res.images_full_url && <Image
                                                    src={res.images_full_url}
                                                ...
                                                <Stack mt='6' spacing='3'>
                                                    ...
                                                    <Text dangerouslySetInnerHTML={{ __html: res?.content }}>

                                                    </Text>
                                                    <Text color='blue.600' fontSize='2xl'>
                                                        Rs. {numDifferentiation(res.price)}
                                                    </Text>
                                                </Stack>
                                            </CardBody>
                                            <Divider />
                                            <CardFooter>
                                                <ButtonGroup spacing='2'>
                                                    ...
                                                    <Toggle size="md" id={res?.id} mutate={mutate} />
                                                </ButtonGroup>
                                            </CardFooter>
                                        </Card>
                                    </>

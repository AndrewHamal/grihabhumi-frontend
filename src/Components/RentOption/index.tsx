        ...
        <Flex alignItems="center" gap={5}>
            <RadioGroup onChange={setValue} value={value}>
                <Stack direction='row' className={style.radioBtnBox}>
                    ...
                    <Radio colorScheme='green' value='apartment' fontSize="10px !important">Apartment</Radio>
                    ...
                    <Radio colorScheme='green' value='commercial' fontSize="10px !important">Commercial Building</Radio>
                </Stack>
            </RadioGroup>
            ...
            {value === 'fullHouse' && <Flex alignItems="center" gap={5}>
                <Select placeholder='House Type' w="150px" border="1px solid #e2e2e2" borderRadius="0" fontSize="13px">
                    <option value='individual'>Individual</option>
                    <option value='housing'>Housing</option>
                    <option value='colony'>Colony</option>
                </Select>
                <Select placeholder='Select option' w="150px" border="1px solid #e2e2e2" borderRadius="0" fontSize="13px">
